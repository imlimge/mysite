  ...
  <body>
    ...
    <div id="main-area">
      <main class="main-area ibx">
        <section class="pt1">
          <div class="cbx bgi bg1"><h2>복싱과 맺은 모델 수주의 이야기</h2></div>
        </section>
        <section class="pt2">
        ...
        <section class="pt2">
          ...
          <div class="cbx bgi bg7"><h2>약, 그렇게 버리면 되돌아옵니다</h2></div>
          <div class="cbx bgi bg8"><h2>셀럽들이 하는 여름 주얼리</h2></div>
        </section>
        <section class="pt1">
        ...
        <section class="pt2">
          ...
          <div class="cbx bgi bg12"><h2>샛노란 ‘자무 주스’가 뜬다!</h2></div>
        </section>
        <section class="pt2">
          <div class="cbx bgi bg13"><h2>체커보드의 색다른 매력</h2></div>
